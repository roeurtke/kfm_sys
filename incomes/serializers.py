...
class IncomeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Income
        fields = ('id', 'date', 'name', 'description', 'income_amount', 'currency', 'income_category', 'status', 'user', 'deleted_at', 'created_at', 'updated_at')  # Fields to include in the API
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.context.get('request').method in ['PUT', 'PATCH']:
            ...
            self.fields['income_amount'].required = False
    ...
    def to_representation(self, instance):
        return {
            ...
            "income_amount": instance.income_amount,
